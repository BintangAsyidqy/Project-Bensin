        ...
        <div class="w-50">
            <div class="">
                <form method="post" class="border border-secondary rounded p-3">
                    <h2 class="text-center mb-3">Bensin Shell</h2>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="jenis" id="tbhanbkar">
                            <option value="Shell Super">Shell Super: Rp. 15.000,00</option>
                            <option value="Shell V-Power">Shell V-Power: Rp. 16.000,00</option>
                            <option value="Shell V-Power Diesel">Shell V-Power Diesel: Rp. 18.000,00</option>
                            <option value="Shell V-Power Nitro">Shell V-Power Nitro: Rp. 16.000,00</option>
                        </select>
                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['proses'])) {
    ...
    echo "<div class='border mt-5 w-50 text-center rounded'>";
      ...
      echo "<p>PPN (10%): Rp. " . number_format($beli->getPpnAmount(), 2, '.', ',') . "</p>";
